  ...
  return (
    <div className="fixed bottom-28 right-8 z-[100]">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="bg-white w-[350px] h-[500px] rounded-[2rem] shadow-2xl border border-brand-ink/5 flex flex-col overflow-hidden mb-4"
          >
      ...
      <button
        ...
        className="w-16 h-16 bg-brand-ink text-brand-paper rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-transform group relative overflow-hidden"
      >
